...
class PlainTextPasswordManager(object):
    ...
    >>> from treegital.password.interfaces import IMatchingPasswordManager
    >>> from treegital.password.managers import PlainTextPasswordManager
...
class SSHAPasswordManager(PlainTextPasswordManager):
    ...
    >>> from zope.interface.verify import verifyObject
    >>> from treegital.password.interfaces import IMatchingPasswordManager
    >>> from treegital.password.managers import SSHAPasswordManager
...
class SMD5PasswordManager(PlainTextPasswordManager):
    ...
    >>> from zope.interface.verify import verifyObject
    >>> from treegital.password.interfaces import IMatchingPasswordManager
    >>> from treegital.password.managers import SMD5PasswordManager
...
class MD5PasswordManager(PlainTextPasswordManager):
    ...
    >>> from zope.interface.verify import verifyObject
    >>> from treegital.password.interfaces import IMatchingPasswordManager
    >>> from treegital.password.managers import MD5PasswordManager
...
class SHA1PasswordManager(PlainTextPasswordManager):
    ...
    >>> from zope.interface.verify import verifyObject
    >>> from treegital.password.interfaces import IMatchingPasswordManager
    >>> from treegital.password.managers import SHA1PasswordManager
